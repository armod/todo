...
export const TodoContainer = () => {
  const { handleSubmit, alert, isEditing, task, setTask, list, showAlert, clearList, removeTodo, removeAllDone, editTask, doneTask } = useGlobalContext()
  return (
    <>
        ...
        {list.length > 0 && (
          <div>
            ...
            <div className='btn-container'>
              ...
              <button className='btn btn-clear' onClick={removeAllDone}>
                clear all done
              </button>
            </div>
          </div>
